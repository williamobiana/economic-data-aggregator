...
3. THE SYSTEM SHALL run the week-final sweep at `0 11 * * 6` UTC (Sat 07:00 ET) with input `{"week_final": true}`. Rollover is Sat 19:00 ET; a sweep on the wrong side of it loses the closing week for good, and this cron clears it by roughly twelve hours in either season.
